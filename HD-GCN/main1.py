...
#     parser.add_argument( '--config',default='./config/nturgbd-cross-subject/bone_com_1test.yaml', help='path to the configuration file')
...
if __name__ == '__main__':
    ...
    Processor = processors['gnn_explainer_oral']
